...
## Project Structure
    ...
    ├── onlineorderprocesso_31210  # Django project configurations
...
1. Clone this repo and `cd onlineorderprocesso_31210`
...
2. Clone this repo and `cd onlineorderprocesso_31210`
